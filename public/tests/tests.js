...
suite('Tests', function(){
  ...
  test('Asignaci&oacute;n', function(){
    obj = pl0.parse("x = 9 .")
  ...
  test('Multiplicaci&oacute;n', function(){
    obj = pl0.parse("x = 4 * 1 .")
    assert.equal(obj[0].right.type, "*") 
  });

  test('Divisi&oacute;n', function(){
    obj = pl0.parse("x = 1 / 6 .")
    assert.equal(obj[0].right.type, "/")
  });
  ...
  test('Par&eacute;ntesis', function(){
  ...
  test('Comparaci&oacute;n', function(){
  ...
  test('Error de Sint&aacute;xis', function(){
