...
El objetivo de la práctica reside en la utilización de PEG.js, un generador automático de analizadores a partir de una gramática, para la creacion de un analizador de PL0 ampliado.
